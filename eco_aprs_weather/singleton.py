...
class ConfigurationSingleton(object):
   def __init__(self):
      ...
      self.telemetry_1_label = config.get('Telemetry 1', 'label', fallback='')
      self.telemetry_1_unit = config.get('Telemetry 1', 'unit', fallback='a')
      self.telemetry_1_eqns = config.get('Telemetry 1', 'eqns', fallback='')
      self.telemetry_1_source = config.get('Telemetry 1', 'source', fallback='')

      self.telemetry_2_label = config.get('Telemetry 2', 'label', fallback='')
      self.telemetry_2_unit = config.get('Telemetry 2', 'unit', fallback='b')
      self.telemetry_2_eqns = config.get('Telemetry 2', 'eqns', fallback='')
      self.telemetry_2_source = config.get('Telemetry 2', 'source', fallback='')

      self.telemetry_3_label = config.get('Telemetry 3', 'label', fallback='')
      self.telemetry_3_unit = config.get('Telemetry 3', 'unit', fallback='c')
      self.telemetry_3_eqns = config.get('Telemetry 3', 'eqns', fallback='')
      ...
      self.telemetry_4_unit = config.get('Telemetry 4', 'unit', fallback='d')
      self.telemetry_4_eqns = config.get('Telemetry 4', 'eqns', fallback='')
      ...
      self.telemetry_5_unit = config.get('Telemetry 5', 'unit', fallback='e')
      self.telemetry_5_eqns = config.get('Telemetry 5', 'eqns', fallback='')
